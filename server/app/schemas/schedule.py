...
# =============================================================================
# Moved from app/models/doctor_weekly_schedules/doctor_weekly_schedule_schemas.py
# Fixed: class Config → model_config = ConfigDict (Pydantic V2)
# =============================================================================
...
class DoctorWeeklyScheduleBase(BaseModel):
    ...
    def validate_end_time(cls, end_time_value, info):
        ...
        Valid: 14:00 → 17:00  |  Invalid: 17:00 → 14:00
        """
...
class DoctorWeeklyScheduleResponse(DoctorWeeklyScheduleBase):
    ...
    # Pydantic V2 style — previously had deprecated `class Config`
