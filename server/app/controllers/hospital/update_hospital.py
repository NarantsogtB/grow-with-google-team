...
from app.exceptions import HospitalUpdateEmptyError, HospitalNotFoundError
...
def update_hospital(db:Database, hospital_id:UUID, hospital_data: HospitalUpdate) -> Hospital:
    ...
    if not update_dict:
        logger.warning(f"{hospital_id} - тай эмнэлэгийн мэдээллийг хоосон талбараар шинэчлэх гэж байна")
